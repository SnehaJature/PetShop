                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-4 col-lg-9 col-md-12 col-sm-9">
                            <div class="adoption-content">
                                <h5 class="sub-title">Meet Breeder</h5>
                                <h2 class="title">Work For <span>Breeder</span> Happy Time</h2>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="adoption-content">
                                <h5 class="sub-title">Meet Breeder</h5>
                                <h2 class="title">Working For <span>Breeder</span> <br> Happy Time</h2>
