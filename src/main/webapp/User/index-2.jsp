        ...
        <main>
            ...
            <section class="slider-area slider-style-two">
                <div class="slider-active">
                    <div class="single-slider slider-bg d-flex align-items-center" data-background="./img/slider/s_slider_bg01.jpg">
                    ...
                    <div class="single-slider slider-bg d-flex align-items-center" data-background="./img/slider/s_slider_bg02.jpg">
                        <div class="container custom-container">
                            <div class="row">
                                <div class="col-xl-5 col-lg-7 col-md-10">
                                    <div class="slider-content">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-4 col-lg-8">
                            <div class="adoption-content">
                                <h2 class="title">Working For <br> Dog <span>Breeder</span> Free, Happy Time</h2>
                                <p>The best overall dog DNA test is embark breed & health Kit view at chewy which provides you with breed brown and
                                information.</p>
                                <a href="breeder.html" class="btn">Breeding <img src="./img/icon/w_pawprint.png" alt=""></a>
                            </div>
                        </div>
