						...
						<div class="footer-widget">
							...
							<div class="footer-text">
								<p>The best overall dog DNA test Embark Breed & Health Kit
									(view at Chewy) which provides overall dog you.</p>
							</div>
							...
							<div class="fw-insta">
								<ul>
									<li><a href="index.html#"><img
											src="img/images/insta_img01.png" alt=""></a></li>
									<li><a href="index.html#"><img
											src="img/images/insta_img02.png" alt=""></a></li>
									<li><a href="index.html#"><img
											src="img/images/insta_img03.png" alt=""></a></li>
									<li><a href="index.html#"><img
											src="img/images/insta_img04.png" alt=""></a></li>
									<li><a href="index.html#"><img
											src="img/images/insta_img05.png" alt=""></a></li>
									<li><a href="index.html#"><img
											src="img/images/insta_img06.png" alt=""></a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
									<a class="dropdown-item" href="index.html"><img
										src="img/icon/russia.png" alt="">Russia</a> <a
